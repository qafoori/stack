import { CircularSinglyLinkedListStack } from '../modules'

describe('TEST CIRCULAR-SINGLY-LINKED-LIST-STACK', () => {
  it('should convert stack into an array', () => {
    const stack = new CircularSinglyLinkedListStack()
  ...
  it('should check if a stack is empty', () => {
    const emptyStack = new CircularSinglyLinkedListStack()
    const filledStack = new CircularSinglyLinkedListStack()
    filledStack.push(1)
